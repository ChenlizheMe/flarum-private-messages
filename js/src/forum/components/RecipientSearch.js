        ...
        {app.cache.conversationsRecipient === null ? (
          <div className="AddRecipientModal-form-input">
            <input
              ...
              type="search"
              placeholder={extractText(app.translator.trans('chenlizheme-private-messages.forum.modal.search_recipients'))}
              value={this.value()}
            ...
            >
              ...
              <li>
                <span>{app.translator.trans('chenlizheme-private-messages.forum.modal.more_users')}</span>
              </li>
            </ul>
          </div>
        ) : (
